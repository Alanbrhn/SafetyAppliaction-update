...
namespace SafetyAppliaction.Migrations
{
    ...
    [Migration("20241025072625_initMigrationNew")]
            ...
            modelBuilder.Entity("SafetyAppliaction.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = 1,
                            CreateBy = "System",
                            CreateDate = new DateTime(2024, 10, 25, 14, 26, 24, 573, DateTimeKind.Local).AddTicks(2107),
                            RoleName = "User"
                        },
                        new
                        {
                            RoleId = 2,
                            CreateBy = "System",
                            CreateDate = new DateTime(2024, 10, 25, 14, 26, 24, 573, DateTimeKind.Local).AddTicks(2122),
                            RoleName = "Admin"
                        },
                        new
                        {
                            RoleId = 3,
                            CreateBy = "System",
                            CreateDate = new DateTime(2024, 10, 25, 14, 26, 24, 573, DateTimeKind.Local).AddTicks(2123),
                            RoleName = "Manager"
                        });
                });
            ...
            modelBuilder.Entity("SafetyAppliaction.Models.Status", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            StatusId = 1,
                            CreateBy = "System",
                            CreateDate = new DateTime(2024, 10, 25, 14, 26, 24, 573, DateTimeKind.Local).AddTicks(2267),
                        ...
                        new
                        {
                            StatusId = 2,
                            CreateBy = "System",
                            CreateDate = new DateTime(2024, 10, 25, 14, 26, 24, 573, DateTimeKind.Local).AddTicks(2269),
                            StatusName = "Checked"
                        },
                        new
                        {
                            StatusId = 3,
                            CreateBy = "System",
                            CreateDate = new DateTime(2024, 10, 25, 14, 26, 24, 573, DateTimeKind.Local).AddTicks(2270),
                            StatusName = "Reviewed"
                        },
                        new
                        {
                            StatusId = 4,
                            CreateBy = "System",
                            CreateDate = new DateTime(2024, 10, 25, 14, 26, 24, 573, DateTimeKind.Local).AddTicks(2271),
                        ...
                        new
                        {
                            StatusId = 5,
                            CreateBy = "System",
                            CreateDate = new DateTime(2024, 10, 25, 14, 26, 24, 573, DateTimeKind.Local).AddTicks(2272),
                        ...
                        new
                        {
                            StatusId = 6,
                            CreateBy = "System",
                            CreateDate = new DateTime(2024, 10, 25, 14, 26, 24, 573, DateTimeKind.Local).AddTicks(2273),
                            StatusName = "Rejected"
                        });
                });
